    ...
    <div id="app">
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center py-3">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('cart.index') }}" class="text-gray-600 hover:text-blue-500 transition duration-200">
                ...
                <div class="pb-4">
                    <form action="{{ route('book.search') }}" method="GET" class="flex items-center">
                        <input type="text" name="query" value="{{ request('search') }}" placeholder="Search books..."
        ...
        <footer class="bg-white shadow-lg">
            <div class="container mx-auto px-4 py-6 text-center text-gray-600">
                <p>&copy; {{ date('Y') }} 🌙 Moonlight & Manuscripts 📜. All rights reserved.</p>
            </div>
        </footer>
    </div>
